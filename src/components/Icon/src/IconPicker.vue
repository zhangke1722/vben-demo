<template>
  <a-input disabled :style="{ width }" :placeholder="'点击选择图标'" :class="prefixCls" v-model:value="currentSelect">
    <template #addonAfter>
        ...
        <template #content>
          <div v-if="getPaginationList.length">
            ...
            <div class="flex py-2 items-center justify-center" v-if="getTotal >= pageSize">
              <a-pagination showLessItems size="small" :pageSize="pageSize" :total="getTotal"
